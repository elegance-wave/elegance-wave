...
if(isset($_POST['update'])){
   ...
   if(!empty($image_01)){
      if($image_size_01 > 2000000){
         ...
         $message[] = 'Figure 01 was successfully updated!';
      }
   }
   ...
   if(!empty($image_02)){
      if($image_size_02 > 2000000){
         ...
         $message[] = 'Figure 02 was successfully updated!';
      }
   }
   ...
   if(!empty($image_03)){
      if($image_size_03 > 2000000){
         ...
         $message[] = 'Figure 03 was successfully updated!';
      }
   }
...
<section class="update-product">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <span>Update Figure 01</span>
      <input type="file" name="image_01" accept="image/jpg, image/jpeg, image/png, image/webp" class="box">
      <span>Update Figure 02</span>
      <input type="file" name="image_02" accept="image/jpg, image/jpeg, image/png, image/webp" class="box">
      <span>Update Figure 03</span>
